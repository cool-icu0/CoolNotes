...
<img src="./一套吃透 Spring 系列.assets/image-20230217084316652.png" alt="image-20230217084316652" style="zoom: 67%;" />
...
![image-20230217083024807](./一套吃透 Spring 系列.assets/image-20230217083024807.png)
...
- BeanFactoryPostProcessor：Bean工厂后处理器，在BeanDefinitionMap填充完毕，Bean实例化之前执行；
  ...
  ![image-20230217153618278](./一套吃透 Spring 系列.assets/image-20230217153618278.png)
...
- BeanPostProcessor：Bean后处理器，一般在Bean实例化之后，填充到单例池singletonObjects之前执行。
  ...
  BeanPos![image-20230217225140540](./一套吃透 Spring 系列.assets/image-20230217225140540.png)
  ...
  <img src="./一套吃透 Spring 系列.assets/image-20230217224315747.png" alt="image-20230217224315747" style="zoom:67%;" />
  ...
  ![image-20230217224702459](./一套吃透 Spring 系列.assets/image-20230217224702459.png)
...
<img src="./一套吃透 Spring 系列.assets/image-20230218055244099.png" alt="image-20230218055244099" style="zoom:80%;" />
...
- 注入双向对象引用属性时，就比较复杂了，涉及了循环引用（循环依赖）问题，下面会详细阐述解决方案。
  ...
  <img src="./一套吃透 Spring 系列.assets/image-20230218055523646.png" alt="image-20230218055523646" style="zoom: 80%;" />
  ...
  ![image-20230218062142253](./一套吃透 Spring 系列.assets/image-20230218062142253.png)

  ![image-20230219020441822](./一套吃透 Spring 系列.assets/image-20230219020441822.png)
  ...
  ![image-20230219021944373](./一套吃透 Spring 系列.assets/image-20230219021944373.png)
...
![image-20230218062616866](./一套吃透 Spring 系列.assets/image-20230218062616866.png)

#### 2.4-7、Spring IoC 整体流程总结

![image-20230219143227229](./一套吃透 Spring 系列.assets/image-20230219143227229.png)
...
![image-20230220085841840](./一套吃透 Spring 系列.assets/image-20230220085841840.png)
...
![image-20230221092555200](./一套吃透 Spring 系列.assets/image-20230221092555200.png)
...
1. 在创建DefaultNamespaceHandlerResolver时，为处理器映射地址handlerMappingsLocation属性赋值，并加载命名空间处理器到Map<String, Object> handlerMappings 中去
   ...
   ![image-20230221092511997](./一套吃透 Spring 系列.assets/image-20230221092511997.png)
...
2. 在DefaultBeanDefinitionDocumentReader的parseBeanDefinitions方法中，发现如下逻辑：
   ...
   ![image-20230221092038716](./一套吃透 Spring 系列.assets/image-20230221092038716.png)

   如果是默认命名空间，则执行parseDefaultElement方法

   ![image-20230221092025074](./一套吃透 Spring 系列.assets/image-20230221092025074.png)

   如果是自定义命名空间，则执行parseCustomElement方法

   ![image-20230221092008207](./一套吃透 Spring 系列.assets/image-20230221092008207.png)
   ...
   ![image-20230221091943310](./一套吃透 Spring 系列.assets/image-20230221091943310.png)
...
![image-20230220092715752](./一套吃透 Spring 系列.assets/image-20230220092715752.png)
...
![image-20230220093050023](./一套吃透 Spring 系列.assets/image-20230220093050023.png)
...
![image-20230220093145844](./一套吃透 Spring 系列.assets/image-20230220093145844.png)
...
![image-20230220093511863](./一套吃透 Spring 系列.assets/image-20230220093511863.png)
...
![image-20230222144621650](./一套吃透 Spring 系列.assets/image-20230222144621650.png)
...
![image-20230222144901290](./一套吃透 Spring 系列.assets/image-20230222144901290.png)

![image-20230222144914289](./一套吃透 Spring 系列.assets/image-20230222144914289.png)
...
![image-20230224120920971](./一套吃透 Spring 系列.assets/image-20230224120920971.png)

#### 3.1-2、AOP思想的实现方案

动态代理技术，在运行期间，对目标对象的方法进行增强，代理对象同名方法内可以执行原有逻辑的同时嵌入执行其他增强逻辑或其他对象方法

![image-20230224121919601](./一套吃透 Spring 系列.assets/image-20230224121919601.png)

#### 3.1-3、模拟AOP基础代码

![image-20230224163534701](./一套吃透 Spring 系列.assets/image-20230224163534701.png)
...
![image-20230224225000195](./一套吃透 Spring 系列.assets/image-20230224225000195.png)
...
4. 配置织入（切点被哪些通知方法增强，是前置增强还是后置增强）
   ...
   ![image-20230225010251865](./一套吃透 Spring 系列.assets/image-20230225010251865.png)
...
![image-20230225133116563](./一套吃透 Spring 系列.assets/image-20230225133116563.png)
...
![image-20230225133923863](./一套吃透 Spring 系列.assets/image-20230225133923863.png)

##### 通知的类型

![image-20230225134104021](./一套吃透 Spring 系列.assets/image-20230225134104021.png)

![image-20230225141040615](./一套吃透 Spring 系列.assets/image-20230225141040615.png)

![image-20230225141402435](./一套吃透 Spring 系列.assets/image-20230225141402435.png)
...
![image-20230225163654037](./一套吃透 Spring 系列.assets/image-20230225163654037.png)
...
![image-20230226115818772](./一套吃透 Spring 系列.assets/image-20230226115818772.png)

![image-20230226145859288](./一套吃透 Spring 系列.assets/image-20230226145859288.png)

Cglib基于超类的动态代理

![image-20230226160412897](./一套吃透 Spring 系列.assets/image-20230226160412897.png)
...
![image-20230227142755945](./一套吃透 Spring 系列.assets/image-20230227142755945.png)

#### 3.3-2、注解方式AOP配置详解

##### 1、配置五种通知的AOP

<img src="./一套吃透 Spring 系列.assets/image-20230227143410473.png" alt="image-20230227143410473" style="zoom:50%;" />

##### 2、切点表达式的抽取

<img src="./一套吃透 Spring 系列.assets/image-20230227144103329.png" alt="image-20230227144103329" style="zoom: 67%;" />
...
![image-20230227160220359](./一套吃透 Spring 系列.assets/image-20230227160220359.png)
...
![image-20230227161948871](./一套吃透 Spring 系列.assets/image-20230227161948871.png)

##### 2、Spring事务控制相关类

主要有如下三个

![image-20230227162236193](./一套吃透 Spring 系列.assets/image-20230227162236193.png)
...
- 数据库准备一个账户表tb_account
  ...
  <img src="./一套吃透 Spring 系列.assets/image-20230227174312490.png" alt="image-20230227174312490" style="zoom:67%;" />
...
![image-20230227231902193](./一套吃透 Spring 系列.assets/image-20230227231902193.png)

![image-20230227232509247](./一套吃透 Spring 系列.assets/image-20230227232509247.png)
...
![image-20230228162116675](./一套吃透 Spring 系列.assets/image-20230228162116675.png)
